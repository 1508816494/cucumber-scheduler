...
public abstract class AbstractJobData<T extends AbstractJobData> implements Comparable<T> {
    ...
    @Override
    public int hashCode() {
        int hash = this.jobName.hashCode() * 31;
        hash = hash + this.groupName.hashCode() * 31;
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        AbstractJobData data = (AbstractJobData)obj;
        return Objects.equals(data.getGroupName(),groupName)
                && Objects.equals(data.getJobName(),jobName);
    }
}
